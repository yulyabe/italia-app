...
export const SELECT_CARD_FOR_TRANSACTION: "SELECT_CARD_FOR_TRANSACTION" =
  "SELECT_CARD_FOR_TRANSACTION";

export const START_PAYMENT: "START_PAYMENT" = "START_PAYMENT";
export const TRANSACTION_DATA_ENTERED: "TRANSACTION_DATA_ENTERED" =
  "TRANSACTION_DATA_ENTERED";
export const STORE_TRANSACTION_DATA: "STORE_TRANSACTION_DATA" =
  "STORE_TRANSACTION_DATA";
export const TRANSACTION_DATA_FETCHED: "PAYMENT_DATA_FETCHED" =
  "PAYMENT_DATA_FETCHED";
export const PROCEED_WITH_PAYMENT: "PROCEED_WITH_PAYMENT" =
  "PROCEED_WITH_PAYMENT";
export const SHOW_SELECTED_CARD_FOR_TRANSACTION: "SHOW_SELECTED_CARD_FOR_TRANSACTION" =
  "SHOW_SELECTED_CARD_FOR_TRANSACTION";
export const SHOW_CARDS_LIST_FOR_TRANSACTION: "SHOW_CARDS_LIST_FOR_TRANSACTION" =
  "SHOW_CARDS_LIST_FOR_TRANSACTION";
export const CONFIRM_TRANSACTION: "CONFIRM_TRANSACTION" = "CONFIRM_TRANSACTION";
export const END_PAYMENT: "END_PAYMENT" = "END_PAYMENT";
